...
[TestFixture]
public class TestPostgreSqlTransportCleanup : FixtureBase
{
    ...
    public void DoesNotBarfInTheBackground()
    {
        ...
        Assert.That(!logLinesAboveInformation.Any(), "Expected no warnings - got this: {0}",
            string.Join(Environment.NewLine, logLinesAboveInformation));
    }
}