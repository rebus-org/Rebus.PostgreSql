...
[TestFixture]
public class TestPostgreSqlOutboxStorage : FixtureBase
{
    PostgreSqlOutboxStorage _storage;
    ...
    protected override void SetUp()
    {
        ...
        PostgreSqlTestHelper.DropAllTables();

        _storage = new PostgreSqlOutboxStorage(GetNewDbConnection, new TableName(tableName));
        _storage.Initialize();
    }
    ...
    {
        var connection = new NpgsqlConnection(PostgreSqlTestHelper.ConnectionString);
        connection.Open();
