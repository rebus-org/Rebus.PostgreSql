...
/// <summary>
/// Configuration extensions for PostgreSql Server-based outbox
/// </summary>
public static class OutboxExtensions
{
    ...
    /// <summary>
    /// Configures PostgreSql Server as the outbox storage
    /// </summary>
    public static void StoreInPostgreSql(this StandardConfigurer<IOutboxStorage> configurer, string connectionString, string tableName)
    {
        if (configurer == null) throw new ArgumentNullException(nameof(configurer));
        if (connectionString == null) throw new ArgumentNullException(nameof(connectionString));
        if (tableName == null) throw new ArgumentNullException(nameof(tableName));

        StoreInPostgreSql(configurer, connectionString, TableName.Parse(tableName));
    }

    /// <summary>
    /// Configures PostgreSql Server as the outbox storage
    /// </summary>
    public static void StoreInPostgreSql(this StandardConfigurer<IOutboxStorage> configurer, string connectionString, TableName tableName)
    {
        if (configurer == null) throw new ArgumentNullException(nameof(configurer));
        if (connectionString == null) throw new ArgumentNullException(nameof(connectionString));
        if (tableName == null) throw new ArgumentNullException(nameof(tableName));
        ...
        configurer
            ...
            .Register(_ => new PostgreSqlOutboxStorage(ConnectionProvider, tableName));
    ...
    /// </summary>
    public static void UseOutbox(this RebusTransactionScope rebusTransactionScope, NpgsqlConnection connection, NpgsqlTransaction transaction)
    {
